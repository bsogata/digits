...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
    ...
    ContactDB.addContact(new Contact(1, "Ira", "Fuse", "124-816-3264",
        "This is not a real address, just a placeholder", ContactDB.getTelephoneType("Mobile"), dietTypesOne));
    ContactDB.addContact(new Contact(2, "Dewey", "Havtoo", "112-358-1321",
        "This is not a real address, just a placeholder", ContactDB.getTelephoneType("Home"), dietTypesTwo));
    ContactDB.addContact(new Contact(3, "Millie", "Meter", "123-456-7890",
        "This is not a real address, just a placeholder", ContactDB.getTelephoneType("Work"), dietTypesThree));
    ContactDB.addContact(new Contact(4, "Sandy", "Beech", "101-010-1010",
        "This is not a real address, just a placeholder", ContactDB.getTelephoneType("Mobile"), dietTypesFour));
  }
}
